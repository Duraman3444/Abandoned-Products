...
class Department(models.Model):
    ...
    head = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='dept_head')
...
class AssignmentCategory(models.Model):
    ...
    description = models.TextField(blank=True)
    default_weight = models.DecimalField(max_digits=5, decimal_places=2, default=1.0)  # Grading weight
    is_active = models.BooleanField(default=True)
...
class Schedule(models.Model):
    ...
    section = models.ForeignKey(CourseSection, on_delete=models.CASCADE, related_name='schedules')
