...
def get_parent_children(user):
    ...
    try:
        ...
        children = Student.objects.filter(
            emergency_contacts__email=user.email,
            is_active=True
        ).distinct().select_related('grade_level').prefetch_related('emergency_contacts')
...
def dashboard_view(request):
    ...
    try:
        ...
        if not children.exists():
            messages.warning(request, "No student records found for your account. Please contact the school office.")
            return render(request, 'parent_portal/dashboard.html', {'error': 'No children found'})
        ...
        for child in children:
            ...
            upcoming_assignments = [
                {'course': 'Mathematics', 'title': 'Quiz on Fractions', 'due_date': timezone.now() + timedelta(days=3)},
                {'course': 'English', 'title': 'Book Report', 'due_date': timezone.now() + timedelta(days=7)},
            ]
            ...
            children_summary.append({
                ...
                'upcoming_assignments': upcoming_assignments[:2],  # Show next 2 assignments
            })
...
def children_view(request):
    ...
    try:
        ...
        for child in children:
            ...
            courses = [
                {'name': 'Mathematics', 'teacher': 'Mr. Johnson', 'grade': 'A-', 'percentage': 88.5},
                {'name': 'English Literature', 'teacher': 'Ms. Davis', 'grade': 'B+', 'percentage': 86.2},
                {'name': 'Science', 'teacher': 'Dr. Wilson', 'grade': 'A', 'percentage': 92.1},
                {'name': 'Social Studies', 'teacher': 'Mr. Rodriguez', 'grade': 'B', 'percentage': 83.7},
                {'name': 'Art', 'teacher': 'Ms. Chen', 'grade': 'A', 'percentage': 95.0},
            ]
            ...
            emergency_contacts = child.emergency_contacts.all().order_by('is_primary', 'relationship')
        ...
        context = {
            'error': 'Unable to load children information at this time.'
        }
...
def child_detail_view(request, student_id):
    ...
    try:
        ...
        courses_with_grades = [
            {
                ...
                'percentage': 88.5,
                'assignments': [
                    {'name': 'Quiz 1', 'grade': 92, 'date': '2024-09-15', 'category': 'Quiz'},
                    {'name': 'Homework Set 1', 'grade': 87, 'date': '2024-09-20', 'category': 'Homework'},
                    {'name': 'Test 1', 'grade': 85, 'date': '2024-09-25', 'category': 'Test'},
                ]
            },
            {
                ...
                'percentage': 86.2,
                'assignments': [
                    {'name': 'Essay 1', 'grade': 88, 'date': '2024-09-18', 'category': 'Essay'},
                    {'name': 'Reading Quiz', 'grade': 82, 'date': '2024-09-22', 'category': 'Quiz'},
                    {'name': 'Discussion Posts', 'grade': 90, 'date': '2024-09-28', 'category': 'Participation'},
                ]
            }
        ]
        ...
        context = {
            'error': 'Unable to load student information at this time.'
        }
...
def grades_view(request, student_id):
    ...
    try:
        ...
        courses_with_grades = [
            {
                ...
                'percentage': 88.5,
                'assignments': [
                    {'name': 'Quiz 1', 'grade': 92, 'max_points': 100, 'date': '2024-09-15', 'category': 'Quiz', 'weight': 20},
                    {'name': 'Homework Set 1', 'grade': 87, 'max_points': 100, 'date': '2024-09-20', 'category': 'Homework', 'weight': 15},
                    {'name': 'Test 1', 'grade': 85, 'max_points': 100, 'date': '2024-09-25', 'category': 'Test', 'weight': 30},
                    {'name': 'Quiz 2', 'grade': 90, 'max_points': 100, 'date': '2024-10-01', 'category': 'Quiz', 'weight': 20},
                    {'name': 'Project', 'grade': 94, 'max_points': 100, 'date': '2024-10-05', 'category': 'Project', 'weight': 25},
                ]
            },
            {
                'name': 'English Literature',
                ...
                'percentage': 86.2,
                'assignments': [
                    {'name': 'Essay 1', 'grade': 88, 'max_points': 100, 'date': '2024-09-18', 'category': 'Essay', 'weight': 30},
                    {'name': 'Reading Quiz', 'grade': 82, 'max_points': 100, 'date': '2024-09-22', 'category': 'Quiz', 'weight': 15},
                    {'name': 'Discussion Posts', 'grade': 90, 'max_points': 100, 'date': '2024-09-28', 'category': 'Participation', 'weight': 20},
                    {'name': 'Vocabulary Test', 'grade': 85, 'max_points': 100, 'date': '2024-10-02', 'category': 'Test', 'weight': 25},
                ]
            },
            {
                'name': 'Science',
                ...
                'percentage': 92.1,
                'assignments': [
                    {'name': 'Lab Report 1', 'grade': 95, 'max_points': 100, 'date': '2024-09-16', 'category': 'Lab', 'weight': 25},
                    {'name': 'Chapter Test', 'grade': 91, 'max_points': 100, 'date': '2024-09-23', 'category': 'Test', 'weight': 30},
                    {'name': 'Lab Practical', 'grade': 90, 'max_points': 100, 'date': '2024-09-30', 'category': 'Lab', 'weight': 25},
                    {'name': 'Research Project', 'grade': 93, 'max_points': 100, 'date': '2024-10-07', 'category': 'Project', 'weight': 20},
                ]
            }
        ]
        ...
        # Missing assignments
        missing_assignments = [
            {'course': 'English Literature', 'title': 'Reading Log Entry', 'due_date': timezone.now() - timedelta(days=3)},
        ]
        ...
        context = {
            'error': 'Unable to load grade information at this time.'
        }
...
def messages_view(request):
    ...
    try:
        ...
        urgent_count = len([msg for msg in messages_data if msg['urgent'] and not msg['read']])
    ...
    try:
        ...
        for child in children:
            emergency_contacts_by_child[child] = child.emergency_contacts.filter(
                ...
                Q(first_name__icontains=request.user.first_name, last_name__icontains=request.user.last_name)
            )
        ...
        context = {
            'error': 'Unable to load profile information at this time.'
        }
