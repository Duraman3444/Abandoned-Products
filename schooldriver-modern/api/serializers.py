...
class EmergencyContactSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'first_name', 'last_name', 'relationship', 'phone_number', 'email', 'is_primary']
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'grade_level', 'primary_contact_email', 'phone_number', 'address',
            'enrollment_date', 'expected_graduation_year', 'is_active',
            'emergency_contacts', 'age'
        ]
...
class StudentSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Student
        fields = ['id', 'student_id', 'first_name', 'last_name', 'grade_level_name', 'is_active']
...
class CourseSectionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CourseSection
        fields = [
            'id', 'course', 'teacher', 'school_year', 'section_number',
            'room', 'max_students', 'student_count', 'is_active'
        ]
...
class EnrollmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Enrollment
        fields = ['id', 'student', 'section', 'enrollment_date', 'is_active', 'current_grade']
...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Assignment
        fields = [
            'id', 'name', 'description', 'due_date', 'max_points', 
            'category', 'is_published', 'section', 'course_name', 'created_at'
        ]
...
class GradeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Grade
        fields = [
            'id', 'assignment', 'enrollment', 'points_earned', 'percentage',
            'letter_grade', 'is_late', 'is_excused', 'comments', 'created_at'
        ]
...
class ScheduleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Schedule
        fields = [
            'id', 'section', 'day_of_week', 'day_name', 'start_time', 
...
class ApplicantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'phone_number', 'address', 'grade_level_applying', 'created_at'
        ]
