...
from academics.models import Course, CourseSection, Enrollment, Assignment, Grade, Schedule, Attendance
from admissions.models import Applicant

from .serializers import (
    UserSerializer, StudentSerializer, StudentSummarySerializer, CourseSerializer,
    CourseSectionSerializer, EnrollmentSerializer, AssignmentSerializer, GradeSerializer,
    ScheduleSerializer, AttendanceSerializer, ApplicantSerializer,
    SchoolYearSerializer, GradeLevelSerializer, StudentStatsSerializer, CourseStatsSerializer,
...
class StudentViewSet(viewsets.ModelViewSet):
    ...
    def grades(self, request, pk=None):
        ...
        ).select_related('assignment__section__course', 'enrollment')
...
class CourseSectionViewSet(viewsets.ModelViewSet):
    ...
    queryset = CourseSection.objects.all().select_related('course', 'teacher', 'school_year')
    serializer_class = CourseSectionSerializer
    permission_classes = [permissions.IsAuthenticated]
    pagination_class = StandardResultsSetPagination
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['course', 'teacher', 'school_year', 'is_active']
    search_fields = ['course__name', 'teacher__first_name', 'teacher__last_name', 'room']
...
class EnrollmentViewSet(viewsets.ModelViewSet):
    ...
    queryset = Enrollment.objects.all().select_related('student', 'section__course', 'section__teacher')
...
class AssignmentViewSet(viewsets.ModelViewSet):
    ...
    queryset = Assignment.objects.all().select_related('section__course', 'section__teacher')
...
class GradeViewSet(viewsets.ModelViewSet):
    ...
    queryset = Grade.objects.all().select_related('assignment__section__course', 'enrollment__student')
...
class ScheduleViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    queryset = Schedule.objects.all().select_related('section__course', 'section__teacher')
...
class AttendanceViewSet(viewsets.ModelViewSet):
    ...
    queryset = Attendance.objects.all().select_related('enrollment__student', 'enrollment__section__course')
...
class ApplicantViewSet(viewsets.ModelViewSet):
    ...
    pagination_class = StandardResultsSetPagination
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['grade_level_applying']
...
class TeacherViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    queryset = User.objects.filter(is_active=True, taught_sections__isnull=False).distinct()
...
def api_stats(request):
    ...
    avg_enrollment = Enrollment.objects.filter(is_active=True).values('section').annotate(
