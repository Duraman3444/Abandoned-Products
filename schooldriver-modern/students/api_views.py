...
class SchoolYearViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(
        description="Get the currently active school year", tags=["students"]
    )
...
@extend_schema_view(
    list=extend_schema(
        description="List all students with filtering and search", tags=["students"]
    ),
    retrieve=extend_schema(
        description="Get detailed student information", tags=["students"]
    ),
...
class StudentViewSet(viewsets.ModelViewSet):
    ...
    @action(
        detail=False, methods=["get"], url_path="by-grade/(?P<grade_level_id>[^/.]+)"
    )
...
@extend_schema_view(
    ...
    retrieve=extend_schema(
        description="Get emergency contact details", tags=["students"]
    ),
