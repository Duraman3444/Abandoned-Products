...
def applicant_csv_export(request):
    ...
    response = HttpResponse(
        ...
        headers={
            "Content-Disposition": 'attachment; filename="admissions_analytics_detailed.csv"'
        },
    )
    ...
    qs = (
        ...
        .prefetch_related("parent_guardians")
        .all()
    )
    ...
    for a in qs:
        ...
        primary_parent_name = (
            getattr(primary_parent, "name", "")
            if primary_parent
            else a.primary_parent_name
        )
        primary_parent_email = (
            getattr(primary_parent, "email", "")
            if primary_parent
            else a.primary_parent_email
        )
        primary_parent_phone = (
            getattr(primary_parent, "primary_phone", "")
            if primary_parent
            else a.primary_parent_phone
        )
