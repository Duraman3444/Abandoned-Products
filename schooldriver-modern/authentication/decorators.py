...
def role_required(
    ...
    def check_role(user):
        ...
        logger.warning(
            f"User {user.username} with role {user_role} denied access to view requiring: {allowed_roles}"
        )
        return False
...
def student_required(
    ...
    actual_decorator = role_required(
        ["Student"], login_url=login_url, redirect_field_name=redirect_field_name
    )
    if function:
...
def parent_required(
    ...
    """
    actual_decorator = role_required(
        ["Parent"], login_url=login_url, redirect_field_name=redirect_field_name
    )
    if function:
        return actual_decorator(function)
    return actual_decorator
...
def staff_required(
    ...
    """
    actual_decorator = role_required(
        ["Staff", "Admin"], login_url=login_url, redirect_field_name=redirect_field_name
    )
    if function:
        return actual_decorator(function)
    return actual_decorator
...
def admin_required(
    ...
    """
    actual_decorator = role_required(
        ["Admin"], login_url=login_url, redirect_field_name=redirect_field_name
    )
    if function:
        return actual_decorator(function)
    return actual_decorator
