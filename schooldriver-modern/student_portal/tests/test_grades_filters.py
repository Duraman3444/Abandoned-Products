...
class GradesFilterTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="test_student", email="test@example.com", password="testpass123"
        )
    ...
    def setup_courses_and_grades(self):
        ...
        category = AssignmentCategory.objects.create(name="Test", weight=100.0)
    ...
    def test_non_student_access(self):
        ...
        non_student = User.objects.create_user(
            username="non_student", email="non@example.com", password="testpass123"
        )
